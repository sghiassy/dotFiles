# Generated by Powerlevel10k configuration wizard on 2019-11-10 at 12:43 PST.
...
() {
  ...
  function my_git_formatter() {
    ...
    # (( $#where > 32 )) && where[13,-13]="…" # Disabled this line to make git branch names full length
